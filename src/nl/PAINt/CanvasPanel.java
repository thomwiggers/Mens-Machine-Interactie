...
public class CanvasPanel extends JPanel {
	...
	public void mousePressed(final MouseEvent arg0) {
	    ...
	    switch (mode) {
	    case ELL:
		currentlyDrawing = new Ellipse(startPoint.x,
			startPoint.y, 0, 0, false);
		break;
	    case ELL_FILLED:
		currentlyDrawing = new Ellipse(startPoint.x,
			startPoint.y, 0, 0, true);
		break;
	    case RECT:
		currentlyDrawing = new Rectangle(startPoint.x,
			startPoint.y, 0, 0, false);
		break;
	    case RECT_FILLED:
		currentlyDrawing = new Rectangle(startPoint.x,
	...
	public void mouseDragged(final MouseEvent arg0) {
	    ...
	    currentlyDrawing.setFrame(startPoint.x,
		    startPoint.y, newPoint.x - startPoint.x,
	...
	public void mouseDragged(final MouseEvent arg0) {
	    ...
	    selected.setFrameFromCorner(startPoint, arg0.getPoint());
	    CanvasPanel.this.repaint();
